...
const pImage1 =
  PlaceHolderImages.find((img) => img.id === "product-image-1")?.imageUrl ||
  "/placeholder.svg";
const pImage2 =
  PlaceHolderImages.find((img) => img.id === "product-image-2")?.imageUrl ||
  "/placeholder.svg";
const pImage3 =
  PlaceHolderImages.find((img) => img.id === "product-image-3")?.imageUrl ||
  "/placeholder.svg";
const pImage4 =
  PlaceHolderImages.find((img) => img.id === "product-image-4")?.imageUrl ||
  "/placeholder.svg";
const pImage5 =
  PlaceHolderImages.find((img) => img.id === "product-image-5")?.imageUrl ||
  "/placeholder.svg";
...
export const products: Product[] = [
  ...
  },
  {
    ...
    createdAt: "2023-10-10T11:10:00.000Z",
    categoryId: null,
  },
  {
    id: "PROD-007",
    ...
    images: [pImage2],
    createdAt: "2023-10-09T16:55:00.000Z",
    categoryId: null,
  },
];
